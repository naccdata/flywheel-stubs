...
from typing import Generic, List, NotRequired, Optional, TypeVar, TypedDict, Unpack
...
class Finder(Generic[T]):
    ...
    def find(self, *args: str, **kwargs: Unpack[FindArgs]) -> List[T]: # -> Any | list[Any] | None:
    ...
    def find_one(self, *args: str, **kwargs: Unpack[FindArgs]) -> T: # -> Any | list[Any] | None:
    ...
    def find_first(self, *args: str, **kwargs: Unpack[FindArgs]) -> Optional[T]: # -> Any | list[Any] | None:
