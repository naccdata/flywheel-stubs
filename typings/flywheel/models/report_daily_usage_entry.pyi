...
class ReportDailyUsageEntry:
    ...
    attribute_map = ...
    rattribute_map = ...
    def __init__(self, year=..., month=..., day=..., group=..., project=..., project_label=..., session_count=..., center_job_count=..., group_job_count=..., center_compute_ms=..., group_compute_ms=..., center_storage_bytes=..., group_storage_bytes=...) -> None:
